...
// var k =1;
    ...
    b.effect = function (e) {
        ...
        if (1 == e) {
            for (var f = 0; f < 60; f++) {
                var d = $('<span class="lover"><img src="../addons/haoman_dpm/wedding_xys/lover/heart'+ parseInt(b.rand(1, 3)) + '.png"/></span>');
                $(".js_effectBox").prepend(d);
                var c = b.rand(0.3, 1.1);
                d.css({
                    background: "url('../addons/haoman_dpm/wedding_xys/lover/lover-shadow'" + parseInt(b.rand(1, 2)) + "'.png') center center no-repeat",
            ...
            if (2 == e) {
                for (var f = 0; f < 15; f++) {
                    var j = $('<img src="../addons/haoman_dpm/wedding_xys/gift/gift' + parseInt(b.rand(1, 6)) + '.png" class="gift"/>');
                    j.css({
                ...
                if (3 == e) {
                    ...
                    if (4 == e) {
                        ...
                        for (var f = 0; f < 50; f++) {
                            ...
                            var c = b.rand(0.3, 1);
                            k.css({
                                background: "url('../addons/haoman_dpm/wedding_xys/star/star" + parseInt(b.rand(1, 6)) + ".png') no-repeat",
                                left: 80 * parseInt(b.rand(1, 18)) + "px",
                                top: 70 * parseInt(b.rand(1, 10)) + "px",
