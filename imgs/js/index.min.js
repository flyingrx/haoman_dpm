...
// debugger;
        ...
        $("#personal_chat").click(function (e) {
            var sid = $("input[name=guest_id]").val();console.log(sid)
            location.href=go_talk+'&sid='+sid;
            e.preventDefault();
        }),
    ...
    //}),
        ...
        $(this).next().click()
    }),$(this).on('click',".msg_box .avatar",function (e) {//点击左侧头像
        if (!$(this).parent().hasClass("mine")){
            var x = $(this).offset();
            $("#ava_tap").show();
            $("#ava_tap").offset({top:x.top,left:x.left+50});
