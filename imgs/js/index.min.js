    ...
    if (i.data && 0 != i.data.length) {
        ...
        d += '</div>';
            ...
            if (1 ==a||e[l].from_user==n) {
                ...
                if(e[l].from_user==n){
                    d +='<span class="aDel" onclick="onWall.del(this,'+e[l].id+')" data-id="'+e[l].id+'">删除</span>';
                }else{
                    if(1 ==a){
                        d +='<span class="aDel" onclick="onWall.del(this,'+e[l].id+')" data-id="'+e[l].id+'">删除</span>';

                        d +='<span class="aBlack" onclick="onWall.toBlack(this)" data-id="'+e[l].from_user+'">拉黑</span>';
                    }
            ...
            a.find("#ds-individual").unbind("click").click(function () {
                if (s.ds_data.detail) {
                    ...
                    n += "</div>", e.html(n), $.TouchSlide({
                        ...
                        s.ds_data.fans_id = $(this).attr("data-id"), $(".fl-ds-guest.selected").removeClass("selected"), $(this).addClass("selected"),$("input[name=guest_id]").val($(this).attr("data-id"));
                    })
                    $("input[name=tp]").val(3);
