...
if ($operation == 'updataad') {
	...
	$updata = array('rid' => $_GPC['rulename'], 'uniacid' => $_W['uniacid'], 'turntable' => $_GPC['turntable'], 'sort' => $_GPC['sort'], 'prizename' => $_GPC['prizename'], 'couponid' => $_GPC['couponid'], 'awardspro' => $_GPC['awardspro'], 'awardstotal' => $_GPC['awardstotal'], 'awardsimg' => $_GPC['awardsimg'], 'ptype' => intval($_GPC['ptype']), 'credit' => $_GPC['credit'] * 100, 'credit2' => $_GPC['credit2'] * 100);
