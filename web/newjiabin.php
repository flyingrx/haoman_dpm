...
if ($operation == 'updataad') {
	...
	$updata = array('rid' => $_GPC['rulename'], 'uniacid' => $_W['uniacid'], 'pid' => $_GPC['pid'], 'name' => $_GPC['name'], 'description' => $_GPC['description'], 'avatar' => $_GPC['avatar'], 'img' => $_GPC['img'], 'status' => $_GPC['status']);
