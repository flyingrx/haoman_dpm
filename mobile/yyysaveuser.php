...
if (empty($from_user)) {
	$data = array('shenyu' => 0, 'msg' => '获取不到您的会员信息，请刷新页面重试', 'status' => $reply['status'], 'code' => 11);
...
pdo_update('haoman_dpm_yyyuser', array('createtime' => $createtime, 'point' => $point, 'endtime' => time()), array('id' => $user['id']));
$data = array('code' => 99);
echo json_encode($data);