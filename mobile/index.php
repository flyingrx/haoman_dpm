...
$reply = pdo_fetch("select is_b_share,id,isallowip,allowip,liucheng,share_url,viewnum,share_title,mobtitle,share_desc,share_imgurl,picture,mobpicurl,isbaoming,is_showjiabin,isjiabin,isqhb,istoupiao,copyright,bottomwordcolor,bottomcolor,registimg from " . tablename('haoman_dpm_reply') . " where rid = :rid order by `id` desc", array(':rid' => $rid));
