...
$reply = pdo_fetch("select id,share_url,viewnum,share_title,share_desc,share_imgurl,picture,mobtitle,isjiabin,istoupiao,isqhb,copyright,is_b_share,bottomcolor,bottomwordcolor from " . tablename('haoman_dpm_reply') . " where rid = :rid order by `id` desc", array(':rid' => $rid));
