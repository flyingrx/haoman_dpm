...
$awardslist = pdo_fetchall("SELECT * FROM " . tablename('haoman_dpm_award') . " WHERE rid = :rid and uniacid = :uniacid and turntable = :turntable and titleid = :titleid ORDER BY id DESC", array(':rid' => $rid, ':uniacid' => $uniacid, ':turntable' => 4, ':titleid' => $awardid));
if ($reply['iscjnum'] == 0) {
	$winUserNum = 0;
...
$data = array('ret' => 1, 'msg' => "success", 'num' => $winUserNum, "data" => $awardslist);
